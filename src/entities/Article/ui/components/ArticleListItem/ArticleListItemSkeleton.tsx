...
export const ArticleListItemSkeleton = memo((props: ArticleListItemSkeletonProps) => {
  ...
  return view === ArticleView.TILE ? (
    <div data-testid="articleListItem.test" className={classNames(cls.articleListItemTileView, mods, [className, cls[view]])}>
      <Card
        renderContent={() => (
        ...
        renderContent={() => (
          <div className={cls.cardInner}>
            ...
            <div className={cls.infoWrapper}>
              ...
              <Skeleton className={cls.skeletonTitle} width={250} height={26} />
            </div>
            <Skeleton className={cls.img} width="100%" height={250} />
            <Skeleton className={cls.skeletonTitle} width="100%" height={120} />
