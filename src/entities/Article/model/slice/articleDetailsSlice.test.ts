...
describe('articleDetailsSlice Extra Reducers Test', () => {
  ...
  test('fetchArticleById Pending Test', async () => {
    const state: DeepPartial<ArticleDetailsSchema> = mockMiscData
  ...
  test('fetchArticleById Fulfilled Test', async () => {
    const state: DeepPartial<ArticleDetailsSchema> = mockMiscData
